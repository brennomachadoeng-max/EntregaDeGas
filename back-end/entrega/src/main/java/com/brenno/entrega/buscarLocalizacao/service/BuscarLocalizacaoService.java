package com.brenno.entrega.buscarLocalizacao.service;

import com.brenno.entrega.buscarLocalizacao.client.GoogleGeocodingClient;
...
public class BuscarLocalizacaoService {
    ...
    public EnderecoRequestDTO buscarLocalizacao(EnderecoRequestDTO endereco) {
    ...
    public EmpresaCadastroDTO buscarLocalizacaoEmpresa(EmpresaCadastroDTO endereco) {
        CoordenadaDTO coordenada = client.buscarCoordenadas(endereco.toString());
        endereco.setLatitude(coordenada.latitude());
        endereco.setLongitude(coordenada.longitude());
        return endereco;
